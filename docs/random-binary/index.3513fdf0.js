...
})({"4Eb2b":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    function initialize(onFinish) {
        let sumTime = 0;
        let sumDeg = 0;
        const ww = new Worker(require("cd44be3764a0c7fe"));
        ww.onmessage = (e)=>{
            const { data } = e;
...
},{"../../../dist/stlics.esm.js":"3s2i8","../util.js":"4C3LP","cd44be3764a0c7fe":"37wXQ"}],"37wXQ":[function(require,module,exports) {
let workerURL = require("85e298b16192d705");
let bundleURL = require("2f1aa89c4032bb95");
let url = bundleURL.getBundleURL("lhL8j") + "../worker.2dcc95cd.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"85e298b16192d705":"cn2gM","2f1aa89c4032bb95":"lgJ39"}],"cn2gM":[function(require,module,exports) {
"use strict";
...
},{}]},["4Eb2b","3LfAa"], "3LfAa", "parcelRequire95bc")
