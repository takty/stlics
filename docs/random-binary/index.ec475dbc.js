...
document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    ww.onmessage = (e)=>{
        ...
        if ("log" in data) log(data.log);
            ...
            if (COUNT <= count) log(`average time: ${sum_time / COUNT}   average rate: ${sum_deg / COUNT}`);
        }
    };
...
},{"../util.js":"cakah","9a83d44b1c7d6351":"bXzUe"}],"cakah":[function(require,module,exports) {
...
},{}],"bXzUe":[function(require,module,exports) {
