...
async function solve(type, targetRate) {
    ...
    const sn = (0, _solverFactoryJs.SolverFactory).crispSolverNames()[type];
...
parcelHelpers.export(exports, "CrispProblem", ()=>CrispProblem);
var _problemJs = require("./problem.js");
var _relationFuzzyJs = require("./relation-fuzzy.js");
class CrispProblem extends (0, _problemJs.Problem) {
    /**
	 ...
	 */ createConstraint(args) {
        if (args.relation instanceof (0, _relationFuzzyJs.FuzzyRelation)) throw new Error();
...
},{"./problem.js":"eeGnE","./relation-fuzzy.js":"fQtZw","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"fQtZw":[function(require,module,exports) {
/**
...
},{}],"8fQJ7":[function(require,module,exports) {
/**
...
},{"./element.js":"hEgcc","./relation-fuzzy.js":"fQtZw","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}]},["eVEWG","dbZx1"], "dbZx1", "parcelRequire7885")
