...
},{"./_variable.js":"../src/problem/_variable.js","./_domain-ranged.js":"../src/problem/_domain-ranged.js","./_domain-arbitrary.js":"../src/problem/_domain-arbitrary.js","./_constraint.js":"../src/problem/_constraint.js","./_constraint-1.js":"../src/problem/_constraint-1.js","./_constraint-2.js":"../src/problem/_constraint-2.js","./_constraint-3.js":"../src/problem/_constraint-3.js"}],"../src/util/_problem-factory.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/model/_n-1-queens.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.N_1_queens = void 0;
...
var N_1_queens = /*#__PURE__*/function (_ProblemFactory) {
  _inherits(N_1_queens, _ProblemFactory);
  var _super = _createSuper(N_1_queens);
  function N_1_queens(queenSize) {
    var _this;
    _classCallCheck(this, N_1_queens);
    _this = _super.call(this);
    ...
    value: function createProblem(p) {
      ...
      for (var i = 0; i < _classPrivateFieldGet(this, _size); ++i) {
        v.push(p.createVariable({
          ...
          domain: p.createDomain({
            min: 1,
            max: _classPrivateFieldGet(this, _size) - 1
          }),
          value: 1
        }));
      }
      for (var _i = 0; _i < _classPrivateFieldGet(this, _size); ++_i) {
        for (var j = _i + 1; j < _classPrivateFieldGet(this, _size); ++j) {
          p.createConstraint({
            relation: new FuzzyQueenRelation(_i, j, _classPrivateFieldGet(this, _size)),
            variables: [v[_i], v[j]]
          });
        }
      }
...
exports.N_1_queens = N_1_queens;
var _dist = /*#__PURE__*/new WeakMap();
var _size2 = /*#__PURE__*/new WeakMap();
var FuzzyQueenRelation = /*#__PURE__*/function (_FuzzyRelation) {
  _inherits(FuzzyQueenRelation, _FuzzyRelation);
  var _super2 = _createSuper(FuzzyQueenRelation);
  function FuzzyQueenRelation(i, j, size) {
    var _this2;
    _classCallCheck(this, FuzzyQueenRelation);
    _this2 = _super2.call(this);
    _classPrivateFieldInitSpec(_assertThisInitialized(_this2), _dist, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this2), _size2, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldSet(_assertThisInitialized(_this2), _dist, j - i);
    _classPrivateFieldSet(_assertThisInitialized(_this2), _size2, size);
    return _this2;
  }
  _createClass(FuzzyQueenRelation, [{
    key: "satisfactionDegree",
    value: function satisfactionDegree(v1, v2) {
      if (v1 !== v2 && v1 !== v2 + _classPrivateFieldGet(this, _dist) && v1 !== v2 - _classPrivateFieldGet(this, _dist)) return 1;
      return (_classPrivateFieldGet(this, _dist) - 1) / (_classPrivateFieldGet(this, _size2) - 1);
    }
  }]);
  return FuzzyQueenRelation;
}(_relationFuzzy.FuzzyRelation);
},{"../util/_problem-factory.js":"../src/util/_problem-factory.js","../problem/_relation-fuzzy.js":"../src/problem/_relation-fuzzy.js"}],"../src/util/_assignment.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(FuzzyForwardChecking, [{
    ...
    function exec() {
      ...
      while (true) {
        ...
        if (this._debug) {
          console.log("\tfound a solution: ".concat(_classPrivateFieldGet(this, _solWorstDeg)));
        }
...
function _flcVariables2(X1, X2, X3, consX1, consX12, rc) {
  var _this$iterCount, _this$iterCount2;
  if (this._debug) {
    console.log("X1 ".concat(X1.size, ", X2' ").concat(X2.size, ", X3' ").concat(X3.size));
  }
      ...
      while (true) {
        ...
        if (!modified) {
          ...
          if (cur < d) {
            ...
            cur = d;
            if (this._debug) console.log("worst satisfaction degree: ".concat(d));
            sol.setProblem(this._pro);
  ...
  _createClass(SRS3, [{
    ...
    value: function exec() {
      ...
      while (true) {
        ...
        if (this._debug) {
          console.log("\tfound a solution: ".concat(solutionWorstDeg, "\t").concat(this._targetDeg));
        }
        sol.setProblem(this._pro);
...
var SRS3_PF = /*#__PURE__*/function (_SRS) {
  ...
  _createClass(SRS3_PF, [{
    ...
    value: function exec() {
      ...
      if (this._debug) {
        console.log("result: ".concat(res ? 'success' : 'failure'));
        console.log("satisfaction degree: ".concat(deg, " -> ").concat(this._pro.worstSatisfactionDegree()));
        console.log("unassigned size: ".concat(uvs, " -> ").concat(this._pro.emptyVariableSize()));
      }
      return res;
    }
  }]);
...
},{"../../util/_assignment-list.js":"../src/util/_assignment-list.js","../filter/_post-stabilization.js":"../src/solver/filter/_post-stabilization.js","./_srs3.js":"../src/solver/fuzzy/_srs3.js"}],"n-1-queens.js":[function(require,module,exports) {
"use strict";

var _problem = require("../src/problem/_problem.js");
var _n1Queens = require("../src/model/_n-1-queens.js");
...
function main() {
  ...
  for (var i = 0; i < COUNT; ++i) {
    var nq = new _n1Queens.N_1_queens(QUEEN_NUM);
    var p = nq.createProblem(new _problem.Problem());
    ...
    console.log("trial: ".concat(i + 1, "   time: ").concat(ct, "   degree: ").concat(cd));
    nq.printResult(p);
    sum_time += ct;
    sum_degree += cd;
  }
  console.log("average time: ".concat(sum_time / COUNT, "   average degree: ").concat(sum_degree / COUNT));
}
main();
},{"../src/problem/_problem.js":"../src/problem/_problem.js","../src/model/_n-1-queens.js":"../src/model/_n-1-queens.js","../src/solver/fuzzy/_fuzzy-forward-checking.js":"../src/solver/fuzzy/_fuzzy-forward-checking.js","../src/solver/fuzzy/_fuzzy-forward-checking-bc.js":"../src/solver/fuzzy/_fuzzy-forward-checking-bc.js","../src/solver/fuzzy/_flexible-local-changes.js":"../src/solver/fuzzy/_flexible-local-changes.js","../src/solver/fuzzy/_flexible-local-changes-ex.js":"../src/solver/fuzzy/_flexible-local-changes-ex.js","../src/solver/fuzzy/_fuzzy-breakout.js":"../src/solver/fuzzy/_fuzzy-breakout.js","../src/solver/fuzzy/_fuzzy-genet.js":"../src/solver/fuzzy/_fuzzy-genet.js","../src/solver/fuzzy/_srs3.js":"../src/solver/fuzzy/_srs3.js","../src/solver/fuzzy/_srs3-pf.js":"../src/solver/fuzzy/_srs3-pf.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","n-1-queens.js"], null)
//# sourceMappingURL=/n-1-queens.ba86140a.js.map