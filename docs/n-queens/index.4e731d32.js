...
})({"4BLRn":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    function initialize(onFinish) {
        let sumTime = 0;
        let sumRate = 0;
        const ww = new Worker(require("bcd009d3fed46858"));
        ww.onmessage = (e)=>{
            const { data } = e;
...
},{"../../../dist/stlics.esm.js":"3s2i8","../util.js":"4C3LP","bcd009d3fed46858":"5j9Ob"}],"5j9Ob":[function(require,module,exports) {
let workerURL = require("99209073f9cad988");
let bundleURL = require("3b786666cb55f91b");
let url = bundleURL.getBundleURL("7kDl7") + "../worker.65edb019.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"99209073f9cad988":"cn2gM","3b786666cb55f91b":"lgJ39"}],"cn2gM":[function(require,module,exports) {
"use strict";
...
},{}]},["4BLRn","cUEci"], "cUEci", "parcelRequire95bc")
