...
})({"gA3HN":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    function initialize(onFinish) {
        let sumTime = 0;
        let sumDeg = 0;
        const ww = new Worker(require("df529d0ad22e829b"));
        ww.onmessage = (e)=>{
            const { data } = e;
...
},{"../../../dist/stlics.esm.js":"3s2i8","../util.js":"4C3LP","df529d0ad22e829b":"bcTbp"}],"bcTbp":[function(require,module,exports) {
let workerURL = require("c4d6e0e8e404f986");
let bundleURL = require("4b9fa2377dcbe50b");
let url = bundleURL.getBundleURL("lNjSa") + "../worker.4809ccdc.js" + "?" + Date.now();
module.exports = workerURL(url, bundleURL.getOrigin(url), false);

},{"c4d6e0e8e404f986":"cn2gM","4b9fa2377dcbe50b":"lgJ39"}],"cn2gM":[function(require,module,exports) {
"use strict";
...
},{}]},["gA3HN","eg3Jd"], "eg3Jd", "parcelRequire95bc")
