...
})({"lffQT":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "a8fb9c35fdafe466";
module.bundle.HMR_BUNDLE_ID = "b8075c2764643546";
"use strict";
...
},{}],"8sNNW":[function(require,module,exports) {
/**
...
class LocalChanges extends (0, _solverJs.Solver) {
    ...
    #lcValue(V1, V2, v2, val2) {
        ...
        V1 = LocalChanges.#setPlusElement(V1, v2);
    ...
    #lcVariable(V11, V21, v3, d) {
        ...
        const al = (0, _assignmentListJs.AssignmentList).fromVariables(V21);
        v3.assign(val);
        const ret = this.#lcValue(V11, V21, v3, val);
        if (ret || this.#globalReturn) return ret;
        v3.clear();
        al.apply();
        return this.#lcVariable(V11, V21, v3, LocalChanges.#setMinusElement(d, val));
    }
    #lcVariables(V12, V22, V3) {
        ...
        if (!ret || this.#globalReturn) return ret;
        V22 = LocalChanges.#setPlusElement(V22, v);
...
},{"../../util/assignment-list.js":"igHYh","../solver.js":"55TFI","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"igHYh":[function(require,module,exports) {
/**
...
},{}],"55TFI":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}]},["lffQT","8sNNW"], "8sNNW", "parcelRequire7885")

//# sourceMappingURL=local-changes.64643546.js.map
